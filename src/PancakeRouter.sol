...
library PancakeLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint160(uint(keccak256(abi.encodePacked(
            ...
            // hex'c8477072823f9d0367621901bc3a021a8ef0945f02c80ac665ea73225b5db3a3' // V1: BSC BT router init code hash
            hex'b9bc1a1087a3415991937889e7775f77f7eafd58514b6de83aeb14d936b45b94' // V2: dev test router init code hash
            // hex'0d3a3c93a5e1bf06aa4aa60f9896f9ac61289efaf0d27b64a56b05dc7918978b' // V2: AVAX/BSC BT router init code hash
        )))));
    }
